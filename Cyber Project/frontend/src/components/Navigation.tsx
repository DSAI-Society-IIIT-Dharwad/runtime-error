...
export default function Navigation({ darkMode, setDarkMode }: NavigationProps) {
  ...
  const navItems = [
    ...
    { path: '/flows', label: 'Network Flows', icon: ChartBarIcon },
    { path: '/alerts', label: 'Alerts', icon: ExclamationTriangleIcon, badge: statistics.criticalAlerts, badgeColor: 'danger' },
