      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Real-time connection visualisation
          </p>
        </div>
        <div className="mt-4 sm:mt-0 flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-primary-500 rounded-full"></div>
            <span className="text-sm">Inside Network</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-danger-500 rounded-full"></div>
            <span className="text-sm">Outside Network</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="card-header">
            <h3 className="text-lg font-medium">Connection Topology</h3>
          </div>
        ...
        >
          <div className="card">
            ...
            <div className="card-body space-y-4">
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Outside Network Connections</p>
